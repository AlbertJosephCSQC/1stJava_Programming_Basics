...
It starts by initializing a variable; a condition, that depends on that variable; and inside the loop they do something
to that variable, like increment it.
